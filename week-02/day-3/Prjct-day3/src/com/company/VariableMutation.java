...
public class VariableMutation {
    public static void main(String[] args) {
        ...
        System.out.println((Math.pow(Double.valueOf(e), 3 )));
        ...
        System.out.println(Math.pow(Double.valueOf(g2), 2 ) > g1);
        ...
        System.out.println(i1 > Math.pow(Double.valueOf(i2), 2) && i1 < Math.pow(Double.valueOf(i2), 3 ) );
